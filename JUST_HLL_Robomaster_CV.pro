...
linux{
INCLUDEPATH += /usr/local/OpenCV4.1.2/include\
               /usr/local/OpenCV4.1.2/include/opencv4\
               /usr/local/OpenCV4.1.2/include/opencv4/opencv2


LIBS += /usr/local/OpenCV4.1.2/lib/libopencv_*.so.4.1.2
